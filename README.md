...
# Business Problem: 
IVF clinics face inefficiencies in appointment scheduling, staff allocation, and
...
# High Level Solution: 
Use predictive analytics and optimization models on historical clinic data to
...
2. Run Python Notebook  
   Open: `Python_code.ipynb`  
3. Open Power BI Dashboard  
   File: `PowerBi_dashbord.pbix`  
